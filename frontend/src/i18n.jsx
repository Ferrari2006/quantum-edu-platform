  ...
  zh: {
    ...
    lab: {
      ...
      guided: {
        ...
        bestFidelity: "最佳保真度 {score}%",
        completionSummary: "{completed}/{total} 项已通过",
        signInProgress: "登录后保存任务成绩",
        readConcept: "先阅读关联概念 →",
        goal: "本次目标",
        steps: "实验步骤",
        acceptance: "自动验收",
  ...
  en: {
    ...
    lab: {
      ...
      guided: {
        ...
        bestFidelity: "Best fidelity {score}%",
        completionSummary: "{completed}/{total} passed",
        signInProgress: "Sign in to save results",
